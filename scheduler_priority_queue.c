...
struct priority_queue_t {
    workload_item** heap; /** Array representing the binary heap */
...
int static is_current_process(int current_time, workload_item *process) {
    return (get_ts(process) <= current_time && current_time <= get_tf(process));
}
